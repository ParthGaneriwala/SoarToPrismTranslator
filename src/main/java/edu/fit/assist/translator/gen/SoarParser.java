...
public class SoarParser extends Parser {
	...
	public final Condition_sideContext condition_side() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 36872L) != 0)) {
				{
				{
				setState(93);
				cond();
	...
	public final State_imp_condContext state_imp_cond() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 68171862638600L) != 0)) {
				{
				setState(101);
				id_test();
				}
	...
	public final Attr_value_testsContext attr_value_tests() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 68171862642696L) != 0)) {
				{
				{
				setState(153);
				value_test();
	...
	public final Conjunctive_testContext conjunctive_test() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 68171862114304L) != 0) );
			setState(182);
			match(T__4);
			}
		}
	...
	public final Disjunction_testContext disjunction_test() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 68169720922112L) != 0) );
			setState(202);
			match(T__21);
			}
		}
			...
			do {
				...
				case 1:
					...
					do {
						...
						_errHandler.sync(this);
						_la = _input.LA(1);
					} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 2203335000064L) != 0) );
					setState(251);
					match(T__13);
					}
					}
	...
	public final Func_callContext func_call() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 68169737703424L) != 0)) {
				{
				{
				setState(258);
				value();
	...
	public final Value_makeContext value_make() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1031916519424L) != 0)) {
				{
				{
				setState(297);
				pref_specifier();
	...
	public final Unary_prefContext unary_pref() throws RecognitionException {
		...
		try {
			...
			setState(318);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 481036632064L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final Unary_or_binary_prefContext unary_or_binary_pref() throws RecognitionException {
		...
		try {
			...
			setState(320);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 550879887360L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
